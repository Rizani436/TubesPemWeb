document.addEventListener('DOMContentLoaded', function() {
    ...
    var savedLokasi = localStorage.getItem("lokasiDropdown");
    var savedKategori = localStorage.getItem("kategoriDropdown");

    if (savedLokasi){
        firstButtonLokasi.classList.remove("active");
        buttonLokasi.forEach(function(button){
            if (button.textContent === savedLokasi) {
                button.classList.add('active');
            }
        });
    }
    ...
    if (savedKategori){
        ...
        buttonsKategori.forEach(function(button){
            if (button.textContent === savedKategori) {
                button.classList.add('active');
            }
        });
    }
