<?php
    ...
    if (isset($_POST['id'])) {
        ...
        $query = "UPDATE baranghilang SET idBarangHilang='$idBarangHilang',uploader='$akun',namaBarang = '$namaBarang', kategoriBarang = '$kategoriBarang', tanggalKehilangan = '$tglKehilangan', tempatKehilangan = '$tmptKehilangan', kotaKabupaten = '$kotaKabupaten', informasiDetail = '$informasiDetail', noHP = '$noHP',tipeImage = '" . $propertiesgambar['mime'] . "', gambarBarang =  '" . $datagambar . "' WHERE idBarangHilang = '$idBarangHilang'";
